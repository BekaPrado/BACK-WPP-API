...
//testes
//http://localhost:5050/v1/whatsapp/data/user/unalterable/?id=1 ok
//http://localhost:5050/v1/whatsapp/data/user/editable/?id=1 ok
//http://localhost:5050/v1/whatsapp/data/contact/user/?id=1 ok
//http://localhost:5050/v1/whatsapp/data/user/conversations/?id=1 ok
//http://localhost:5050/v1/whatsapp/filter/contact/?id=1&name=Ana Maria ok
//http://localhost:5050/v1/whatsapp/filter/messages/?id=1&name=Ana Maria&word=hello ok
